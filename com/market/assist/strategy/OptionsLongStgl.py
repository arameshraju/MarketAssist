...
def getSrikePrice(srike,expiry,optType,tranDate):
    QRY_STR= "select sum(close) from market.bankniftyfnodata  where strike_pr=" + srike +" and expiry_dt='"+ expiry+"' and  option_typ IN ('CE','PE')  AND trandate='"+tranDate+"'"
    # print(QRY_STR)
